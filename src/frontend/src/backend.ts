...
export class Backend implements backendInterface {
    ...
    async addAllowlistEntry(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addAllowlistEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllowlist(): Promise<Array<Principal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllowlist();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeAllowlistEntry(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeAllowlistEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
